...
public class PublicArmorSlot extends Slot {
    ...
    public void setStack(ItemStack stack, ItemStack previousStack) {
        if (entity != null) {
            this.entity.onEquipStack(this.equipmentSlot, previousStack, stack); // You may need to implement this
        }
    ...
    public Pair<Identifier, Identifier> getBackgroundSprite() {
        return this.backgroundSprite != null
                ? Pair.of(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, this.backgroundSprite)
                : super.getBackgroundSprite();
    }
}
